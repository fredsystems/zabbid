-- Remove foreign key constraint for areas.round_group_id
-- SQLite requires recreating the table to remove foreign key constraints

-- Create new areas table without round_group_id foreign key
