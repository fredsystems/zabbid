...
ALTER TABLE users ADD COLUMN excluded_from_bidding INTEGER NOT NULL DEFAULT 0 CHECK(excluded_from_bidding IN (0, 1));
...
ALTER TABLE users ADD COLUMN excluded_from_leave_calculation INTEGER NOT NULL DEFAULT 0 CHECK(excluded_from_leave_calculation IN (0, 1));
