...
**Goal:**
Safely expose state-changing operations while enforcing authorization and preserving audit guarantees.

Phase 5 introduces controlled mutation through authenticated and authorized interfaces.

### Phase 5: Scope

Phase 5 includes:

- Write-capable APIs that issue domain commands
- Authentication of callers
- Authorization rules for command execution
- Enforcement of role-based or capability-based access
- Audit attribution of all state-changing actions

Phase 5 explicitly excludes:

- New domain rules
- Changes to persistence or rollback semantics
- UI or frontend concerns
- Performance optimization

### Phase 5: Exit Criteria

- All state changes occur through authorized commands
- Unauthorized actions fail explicitly
- Audit events correctly attribute actors and causes
- Domain and persistence behavior remains unchanged
